...
const PageControls = ({ page, setPage, totalPages }) => {
    ...
    return (
        <div className="page-controls">
            <button className='page-control button' onClick={onPrev} disabled={prevDisabled}>⬅️</button>
            <span className='page-control page'>{page} / {totalPages}</span>
            <button className='page-control button' onClick={onNext} disabled={nextDisabled}>➡️</button>
        </div>
    );
};
